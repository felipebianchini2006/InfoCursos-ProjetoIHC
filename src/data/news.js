export const news = [
  {
    ...
    cover: {
      ...
      alt: 'Professora utilizando tecnologia com estudantes em sala de aula',
  ...
  },
  {
    ...
    references: [
      {
        label: 'Stack Pulse Report 2025',
        url: 'https://stackpulse.dev/2025-report',
      },
    ],
  },
  {
    ...
    cover: {
      ...
      alt: 'Equipe de tecnologia discutindo ideias em frente a um painel com post-its coloridos',
